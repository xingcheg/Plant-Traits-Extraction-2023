...
* If you see error: AttributeError: 'Sequential' object has no attribute 'predict_proba, this is because you are using the *tensorflow* version 2.6+, please manually change function 'predict_proba' to 'predict'. <span style="color:blue">some *This is Blue italic.* text</span>
